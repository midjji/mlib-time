...
/// short name for the specific clock timepoint
typedef std::chrono::time_point<std::chrono::steady_clock,std::chrono::nanoseconds > NS_tp;
#else
/// short name for the specific clock timepoint
typedef std::chrono::time_point<std::chrono::steady_clock, std::chrono::nanoseconds > NS_tp;
//typedef std::chrono::time_point<std::chrono::system_clock, NS_dur > NS_tp; // needed in windows before 2016
#endif
